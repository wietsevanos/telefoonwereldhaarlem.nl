...
function Home() {
  return (
    <SiteShell>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-[1fr_2fr] gap-12 lg:gap-16 items-start">
            <div>
              ...
              <h2 className="mt-3 text-3xl md:text-4xl font-bold tracking-tight">
                Beoordeeld met een dikke 4,8.
              </h2>
              <div className="mt-6 flex items-center gap-3">
                <span className="text-3xl font-bold">4,8</span>
                <span className="text-brand-500 text-xl">★★★★★</span>
              </div>
              <p className="mt-3 text-brand-900/60">Op basis van 500+ reviews van Haarlemse klanten.</p>
            </div>
      ...
      {/* ACCESSOIRES + PAKKETPUNT STRIP */}
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-6">
          <Link to="/accessoires" className="group rounded-3xl p-8 bg-white border border-[color:var(--color-hairline)] hover:border-brand-500/30 hover:shadow-[var(--shadow-lift)] transition-all">
          ...
          <Link to="/pakketpunt" className="group rounded-3xl p-8 bg-brand-900 text-white hover:shadow-[var(--shadow-glow)] transition-all">
