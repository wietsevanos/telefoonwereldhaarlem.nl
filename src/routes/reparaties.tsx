                                ...
                                <div key={key}>
                                  <div className="px-5 sm:px-6 py-4 flex items-center justify-between gap-4">
                                    <div className="min-w-0 flex-1">
                                      ...
                                      <p className="text-xs text-brand-900/50 mt-0.5">
                                        {price.onRequest ? (
                                          ...
                                          <span className="inline-flex items-center gap-1.5">
                                            <span className="text-brand-900/40">Vanaf</span>
                                      ...
                                      {isPhoneScreen && (
                                        <button
                                          onClick={() => setOpenScreenInfo(screenInfoOpen ? null : screenInfoKey)}
                                          className="mt-2 inline-flex items-center gap-1 text-[11px] font-medium text-brand-600 hover:text-brand-700 transition-colors"
                                        >
